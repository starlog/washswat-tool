...
module.exports = {
    ...
    stringifyWithoutCircular: stringifyWithoutCircular,
    debugDump: debugDump,
    getIp: getIp,
...
function debugDump(object, arrayLimit, stringLimit, isPretty)
{
    ...
    try
    {
        if (_.isArray(object))
        {
            ...
            if (isNullOrUndefinedOrEmpty(isPretty) || isPretty === true)
            {
