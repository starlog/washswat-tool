...
const myCache = new NodeCache({stdTTL: 100, checkperiod: 20});
...
exports.get = function (cachekey, callback)
{
    ...
    else
    {
        ...
        try
        {
            logger.debug('redisCache.js using node.js cache read result='+result);
...
exports.set = function (cachekey, value, ttl, callback)
{
    if (value)
    {
        ...
        else
        {
            ...
            logger.debug('redisCache.js using node.js cache write(TTL:'+ttl+') data='+saveData);
